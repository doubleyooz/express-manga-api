...
routes.get('/user/read', easyAuth(), UserMiddleware.valid_read, UserController.read);
routes.get('/user/list', easyAuth(),  UserMiddleware.valid_list,UserController.list);
routes.put('/user', Authorize(["Scan", "User"]), UserMiddleware.valid_update, UserController.update)
routes.delete('/user', Authorize(["Scan", "User"]), UserMiddleware.valid_remove, UserController.remove);
...
routes.post('/manga', Authorize("Scan"), UploadMiddleware.upload_single, MangaMiddleware.valid_store, MangaController.store);
routes.get('/manga/list',  easyAuth(), MangaMiddleware.valid_list, MangaController.list);
routes.get('/manga/read',  easyAuth(), MangaMiddleware.valid_read, MangaController.read);
routes.put('/manga', Authorize("Scan"), MangaMiddleware.valid_update, MangaController.update);
routes.delete('/manga', Authorize("Scan"), MangaMiddleware.valid_remove, MangaController.remove);
...
//routes.put('/manga/review', Authorize("User"), ReviewMiddleware.valid_update, ReviewController.update);
//routes.delete('/manga/review', Authorize("User"), ReviewMiddleware.valid_remove, ReviewController.remove);
...
routes.get('/chapter/read', easyAuth(), ChapterMiddleware.valid_read, ChapterController.read);
routes.put('/chapter', Authorize("Scan"), ChapterMiddleware.valid_update, ChapterController.update);
routes.delete('/chapter', Authorize("Scan"), ChapterMiddleware.valid_remove,  ChapterController.remove);

routes.post('/author', Authorize("Scan"), UploadMiddleware.upload_many_author, AuthorMiddleware.valid_store, AuthorController.store);
routes.put('/author', AuthorMiddleware.valid_update, Authorize("Scan"), AuthorController.update);
